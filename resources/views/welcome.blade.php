<!-- @@extends -> para llamar a nuestra plantilla -->
@extends('layout')
<!-- Con la directiva section podemos indicar que este contenido se muestre en la posicion que nosotros deseamos
para ello la directiva section debe tener el mismo nombre que yield
Abrimos con @@section y cerramos con @@stop
-->
@section('content')
		...
		<article class="post no-image">
			<div class="content-post">
				<header class="container-flex space-between">
					<div class="date">
						<!-- Por defecto laravel trata a las fechas de created_at y updated_at como instancias de carbon que es una libreria
						de php que permite tratar las fechas de manera mas intuitiva y agradable.
						published_at -> que hemos creado nosotros no lo esta tomando como una instancia de carbon  -->
						<span class="c-gray-1">{{ $post->published_at->format('M d') }}</span>
						<!-- <span class="c-gray-1">{{ $post->published_at->diffForHumans('M d') }}</span> -->
					</div>
